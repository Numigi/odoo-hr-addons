odoo.define('hr_attendance_reason_kiosk_mode.employee_kanban', function(require) {
"use strict";

var KanbanRecord = require('web.KanbanRecord');
var AttendanceKanbanRecord = require('hr_attendance.employee_kanban_view_handler');
    ...
    _openRecord: function () {
        if (this.modelName === 'hr.employee' && this.$el.parents('.o_hr_employee_attendance_kanban').length) {
            ...
            var action = {
                ...
                attendance_reasons: this.state.context.attendance_reasons
            };
...
AttendanceKanbanRecord = KanbanRecord
