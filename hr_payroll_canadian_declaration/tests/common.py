                ...
                "rule_ids": [
                    (
                        ...
                        [
                            ...
                            cls.env.ref("payroll.hr_salary_rule_convanceallowance1").id,
                            cls.env.ref("payroll.hr_salary_rule_professionaltax1").id,
                            cls.env.ref("payroll.hr_salary_rule_providentfund1").id,
                            cls.env.ref("payroll.hr_salary_rule_meal_voucher").id,
                            cls.env.ref("payroll.hr_salary_rule_sales_commission").id,
                        ],
                    )
                ],
            }
