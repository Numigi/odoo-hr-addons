...
class TestPayslip(PayrollPreparationToPayslipCase):
    ...
    def setUpClass(cls):
        ...
        cls.rule_a = cls.env.ref("payroll.hr_salary_rule_houserentallowance1")

    def test_00_compute_new_canadian_declaration_box(self):
        self.rule_a.t4_box = "Text T4 BOX"
        self.rule_a.r1_box = "Text R1 BOX"
        self.payslip.compute_sheet()
        payslip_rule_a_line = self.payslip.line_ids.filtered(
            lambda p: p.salary_rule_id.id == self.rule_a.id
        )
